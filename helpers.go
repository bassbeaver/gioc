...
func getArgumentValueFromString(kind reflect.Kind, stringValue string) interface{} {
	...
	case reflect.Int64:
		...
		switch kind {
		case reflect.Int: return int(intVal)
		case reflect.Int8: return int8(intVal)
		case reflect.Int16: return int16(intVal)
		case reflect.Int32: return int32(intVal)
		}
		return intVal
	...
	case reflect.Uint64:
		...
		errorProcessor(conversionError, kind, stringValue)
		switch kind {
		case reflect.Uint: return uint(intVal)
		case reflect.Uint8: return uint8(intVal)
		case reflect.Uint16: return uint16(intVal)
		case reflect.Uint32: return uint32(intVal)
		}
		return intVal
	...
	case reflect.Float64:
		...
		errorProcessor(conversionError, kind, stringValue)
		switch kind {
		case reflect.Float32: return float32(floatVal)
		}
		return floatVal
	case reflect.Bool:
